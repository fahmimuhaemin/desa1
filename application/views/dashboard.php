  ...
  <html>
    ...
    <body id="home" class="scrollspy">
            ...
            <div class="container">
              <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                  ...
                  <li><a class="list" href="#sistem">Sistem Kegiatan/Berita</a></li>
      ...
      <div class="slider">
        <ul class="slides">
          <!-- <li>
           ...
           <li>
            <img src="<?php echo base_url('assets') ?>/user/img/slider/darma.jpg"> <!-- random image -->
            <div class="caption center-align">
              <h3>Selamat Datang di Desa Kawahmanuk</h3>
              <h5 class="light grey-text text-lighten-3">KECAMATAN Darma - KABUPATEN Kuningan</h5>
            </div>
      ...
      <section id="sistem" class="contact grey lighten-3 scrollspy">
        <div class="container">
          <h3 class="center light grey-text text-darken-3">Sistem Kegiatan/Berita</h3>
          <div class="row">
      ...
      <footer class="yellow darken-3 white-text center">
        <p style="font-size: 15px;" class="flow-text">copyright KKN Kelompok 33 Universitas Kuningan <?php echo date('Y'); ?></p>
      </footer>
